...
bool ACharacterBase::ApplyGameplayEffectToSelf(TSubclassOf<UGameplayEffect> Effect,
...
FCharacterData ACharacterBase::GetCharacterData() const
{
	return CharacterData;
}

void ACharacterBase::SetCharacterData(const FCharacterData& InCharacterData)
{
...
void ACharacterBase::OnJumpActionStarted()
{
...
void ACharacterBase::OnJumpActionStopped()
{
	// StopJump();
}

void ACharacterBase::OnCrouchActionStarted()
{
...
void ACharacterBase::OnCrouchActionStopped()
{
	if(AbilitySystemComponent)
	{
...
UFootstepsComponent* ACharacterBase::GetFootstepsComponent() const
{
	return FootstepsComponent;
}

void ACharacterBase::OnRep_CharacterData()
{
	InitFromCharacterData(CharacterData, true);
}

void ACharacterBase::InitFromCharacterData(const FCharacterData& InCharacterData, bool bFromReplication)
{
}
...
void ACharacterBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps)
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME(ACharacterBase, CharacterData);
}
