...
#include "PhysicalMaterials/ShishaPhysicalMaterial.h"
...
{
	if(AShishaCharacterBase* Character = Cast<AShishaCharacterBase>(GetOwner()))
	{
		...
		if(USkeletalMeshComponent* Mesh = Character->GetMesh())
		{
			...
			))
			{
				if(HitResult.bBlockingHit)
				{
					...
					{
						UShishaPhysicalMaterial* PhysicalMaterial = Cast<UShishaPhysicalMaterial>(HitResult.PhysMaterial.Get());
